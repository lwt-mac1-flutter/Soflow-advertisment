      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 signage:px-12 signage:py-8 pb-24 max-w-[1400px] mx-auto w-full">
        ...
        >
          ...
          <div className="relative w-full signage:w-1/2 min-h-[240px] signage:min-h-[400px]">
            ...
            <div className="absolute top-4 right-4 bg-white/[0.15] backdrop-blur-md border border-white/20 px-4 py-2 rounded-full text-[#FF6B4A] font-black text-lg shadow-md">
              {product.price}
            </div>
          </div>
          ...
          <div className="p-6 signage:p-10 flex-1 flex flex-col justify-center">
            <h1 className="text-3xl signage:text-4xl font-black text-white mb-4 tracking-tight">
              {product.name}
            </h1>
            <p className="text-lg signage:text-xl text-white/70 font-medium mb-6 leading-relaxed">
